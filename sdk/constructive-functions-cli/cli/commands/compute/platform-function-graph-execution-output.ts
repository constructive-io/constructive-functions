/**
 * CLI commands for PlatformFunctionGraphExecutionOutput
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const result = await client.platformFunctionGraphExecutionOutput
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(
      answers,
      fieldSchema
    ) as CreatePlatformFunctionGraphExecutionOutputInput['platformFunctionGraphExecutionOutput'];
    const client = getClient('compute');
    const result = await client.platformFunctionGraphExecutionOutput
      .create({
        data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(
      answers,
      fieldSchema
    ) as PlatformFunctionGraphExecutionOutputPatch;
    const client = getClient('compute');
    const result = await client.platformFunctionGraphExecutionOutput
      .update({
        where: {
