-- Deploy: schemas/constructive_users_public/tables/users/columns/display_name/alterations/alt0000000005
-- made with <3 @ constructive.io

-- requires: schemas/constructive_users_public/schema
-- requires: schemas/constructive_users_public/tables/users/table
-- requires: schemas/constructive_users_public/tables/users/columns/display_name/column
