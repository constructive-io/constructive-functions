-- Deploy: schemas/constructive_objects_public/procedures/insert_node_at_path/procedure
-- made with <3 @ constructive.io

-- requires: schemas/constructive_objects_public/schema


CREATE FUNCTION "constructive_objects_public".insert_node_at_path(
  IN s_id uuid,
  IN root uuid,
  IN path text[],
  IN data jsonb,
...
DECLARE
  _newnode_id uuid;
  _newparent_id uuid;
  _parent "constructive_objects_public".object;
  _orig_name text;
  _repl uuid;
  ...
  _pos int;
  _cur_id uuid;
  _cur_obj "constructive_objects_public".object;
  _cached "constructive_objects_public".object[];
  children_hash jsonb;
BEGIN
