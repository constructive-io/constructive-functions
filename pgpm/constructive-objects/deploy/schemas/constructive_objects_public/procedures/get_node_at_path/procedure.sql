-- Deploy: schemas/constructive_objects_public/procedures/get_node_at_path/procedure
-- made with <3 @ constructive.io

-- requires: schemas/constructive_objects_public/schema


CREATE FUNCTION "constructive_objects_public".get_node_at_path(
  IN s_id uuid,
  IN id uuid,
  IN path text[] DEFAULT ARRAY[]::text[]
) RETURNS "constructive_objects_public".object AS $_PGFN_$
DECLARE
  _path text[] := path;
  _obj "constructive_objects_public".object;
  i int;
  pos int;
  curpath text;
  _node_id uuid;
