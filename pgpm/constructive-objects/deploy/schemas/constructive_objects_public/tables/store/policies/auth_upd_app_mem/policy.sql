-- Deploy: schemas/constructive_objects_public/tables/store/policies/auth_upd_app_mem/policy
...
CREATE POLICY auth_upd_app_mem ON "constructive_objects_public".store
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
