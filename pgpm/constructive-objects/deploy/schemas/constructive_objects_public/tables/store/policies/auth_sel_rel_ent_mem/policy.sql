-- Deploy: schemas/constructive_objects_public/tables/store/policies/auth_sel_rel_ent_mem/policy
-- made with <3 @ constructive.io

-- requires: schemas/constructive_objects_public/schema
-- requires: schemas/constructive_objects_public/tables/store/table
-- requires: schemas/constructive_objects_public/tables/store/policies/enable_row_level_security


CREATE POLICY auth_sel_rel_ent_mem ON "constructive_objects_public".store
FOR SELECT
TO authenticated
USING (
