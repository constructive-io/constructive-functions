-- Deploy: schemas/constructive_objects_public/tables/commit/policies/auth_sel_rel_ent_mem/policy
...
CREATE POLICY auth_sel_rel_ent_mem ON "constructive_objects_public".commit
FOR SELECT
TO authenticated
USING (
