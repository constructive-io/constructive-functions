-- Deploy: schemas/constructive_objects_public/tables/ref/policies/auth_ins_app_mem/policy
...
CREATE POLICY auth_ins_app_mem ON "constructive_objects_public".ref
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
