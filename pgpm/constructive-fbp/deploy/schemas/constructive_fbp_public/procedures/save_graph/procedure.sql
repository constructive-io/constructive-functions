-- Deploy: schemas/constructive_fbp_public/procedures/save_graph/procedure
-- made with <3 @ constructive.io

-- requires: schemas/constructive_fbp_public/schema


CREATE FUNCTION "constructive_fbp_public".save_graph(
  IN graph_id uuid,
  IN root_hash uuid,
...
BEGIN
  ...
  FROM "constructive_fbp_public".graph_ref AS r
  WHERE
  ...
  WHERE
    (r.database_id = v_graph.database_id AND r.store_id = v_graph.store_id) AND r.name = 'main';
  UPDATE "constructive_fbp_public".function_graphs SET
