-- Deploy: schemas/constructive_fbp_public/tables/function_graphs/indexes/idx_function_graphs_unique_name
...
CREATE UNIQUE INDEX idx_function_graphs_unique_name ON "constructive_fbp_public".function_graphs ( database_id, name );
