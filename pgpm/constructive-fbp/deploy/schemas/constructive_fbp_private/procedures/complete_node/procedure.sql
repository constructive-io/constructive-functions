-- Deploy: schemas/constructive_fbp_private/procedures/complete_node/procedure
-- made with <3 @ constructive.io

-- requires: schemas/constructive_fbp_private/schema


CREATE FUNCTION "constructive_fbp_private".complete_node(
...
BEGIN
  ...
  PERFORM "constructive_fbp_private".tick_execution(complete_node.execution_id);
END;
