-- Deploy: schemas/constructive_fbp_private/procedures/serialize_graph/procedure
-- made with <3 @ constructive.io

-- requires: schemas/constructive_fbp_private/schema


CREATE FUNCTION "constructive_fbp_private".serialize_graph(
  IN graph_id uuid
...
BEGIN
  ...
  FOR v_row IN SELECT
    path,
    data
  FROM "constructive_fbp_public".graph_get_all(v_graph.database_id, v_tree_id) LOOP
