-- Deploy: schemas/constructive_storage_public/tables/platform_buckets/policies/auth_sel_mem/policy
...
CREATE POLICY auth_sel_mem ON "constructive_storage_public".platform_buckets
FOR SELECT
TO authenticated
USING (
