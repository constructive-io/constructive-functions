-- Deploy: schemas/constructive_storage_public/tables/platform_files/policies/auth_ins_mem/policy
...
CREATE POLICY auth_ins_mem ON "constructive_storage_public".platform_files
FOR INSERT
TO authenticated
WITH CHECK (
