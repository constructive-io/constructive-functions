-- Deploy: schemas/constructive_storage_public/tables/platform_files/policies/auth_upd_esc_write/policy
...
CREATE POLICY auth_upd_esc_write ON "constructive_storage_public".platform_files
FOR UPDATE
TO authenticated
USING (
