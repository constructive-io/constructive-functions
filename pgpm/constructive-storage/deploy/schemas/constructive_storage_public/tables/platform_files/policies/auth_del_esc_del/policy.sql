-- Deploy: schemas/constructive_storage_public/tables/platform_files/policies/auth_del_esc_del/policy
...
CREATE POLICY auth_del_esc_del ON "constructive_storage_public".platform_files
FOR DELETE
TO authenticated
USING (
