-- Deploy: schemas/constructive_compute_fbp_public/procedures/create_function_graph/procedure
-- made with <3 @ constructive.io

-- requires: schemas/constructive_compute_fbp_public/schema


CREATE FUNCTION "constructive_compute_fbp_public".create_function_graph(
  IN database_id uuid,
  IN name text,
...
BEGIN
  ...
  PERFORM "constructive_compute_fbp_public".platform_function_graph_init_empty_repo(create_function_graph.database_id, v_store_id);
