-- Deploy: schemas/constructive_compute_fbp_public/procedures/read_function_graph/procedure
-- made with <3 @ constructive.io

-- requires: schemas/constructive_compute_fbp_public/schema


CREATE FUNCTION "constructive_compute_fbp_public".read_function_graph(
  IN graph_id uuid
...
BEGIN
  ...
  WHERE
    id = read_function_graph.graph_id INTO v_graph;
  IF NOT (FOUND) THEN
