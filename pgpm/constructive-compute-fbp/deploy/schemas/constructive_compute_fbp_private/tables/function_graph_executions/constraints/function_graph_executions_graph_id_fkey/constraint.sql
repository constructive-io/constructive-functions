-- Deploy: schemas/constructive_compute_fbp_private/tables/function_graph_executions/constraints/function_graph_executions_graph_id_fkey/constraint
...
-- requires: schemas/constructive_compute_fbp_public/tables/function_graphs/constraints/function_graphs_pkey/constraint
...
ALTER TABLE "constructive_compute_fbp_private".function_graph_executions 
  ADD CONSTRAINT function_graph_executions_graph_id_fkey 
    ...
    REFERENCES "constructive_compute_fbp_public".function_graphs (id);
