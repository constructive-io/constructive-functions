-- Deploy: schemas/constructive_compute_fbp_private/procedures/platform_function_graph_object_hash_uuid/procedure
-- made with <3 @ constructive.io

-- requires: schemas/constructive_compute_fbp_private/schema


CREATE FUNCTION "constructive_compute_fbp_private".platform_function_graph_object_hash_uuid(
  IN obj "constructive_compute_fbp_public".platform_function_graph_object
