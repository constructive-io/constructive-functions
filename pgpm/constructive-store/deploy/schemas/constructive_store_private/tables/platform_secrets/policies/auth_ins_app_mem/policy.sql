-- Deploy: schemas/constructive_store_private/tables/platform_secrets/policies/auth_ins_app_mem/policy
...
CREATE POLICY auth_ins_app_mem ON "constructive_store_private".platform_secrets
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
