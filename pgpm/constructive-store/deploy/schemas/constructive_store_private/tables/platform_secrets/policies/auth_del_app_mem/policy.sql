-- Deploy: schemas/constructive_store_private/tables/platform_secrets/policies/auth_del_app_mem/policy
...
CREATE POLICY auth_del_app_mem ON "constructive_store_private".platform_secrets
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
