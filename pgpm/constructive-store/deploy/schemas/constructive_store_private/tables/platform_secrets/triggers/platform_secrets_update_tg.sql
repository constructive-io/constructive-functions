-- Deploy: schemas/constructive_store_private/tables/platform_secrets/triggers/platform_secrets_update_tg
...
CREATE TRIGGER platform_secrets_update_tg
BEFORE UPDATE ON "constructive_store_private".platform_secrets
FOR EACH ROW
