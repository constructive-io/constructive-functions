-- Deploy: schemas/constructive_store_private/tables/org_secrets/policies/auth_ins_ent_mem/policy
...
CREATE POLICY auth_ins_ent_mem ON "constructive_store_private".org_secrets
FOR INSERT
TO authenticated
WITH CHECK (
