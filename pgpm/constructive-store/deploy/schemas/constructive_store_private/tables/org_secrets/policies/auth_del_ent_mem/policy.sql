-- Deploy: schemas/constructive_store_private/tables/org_secrets/policies/auth_del_ent_mem/policy
...
CREATE POLICY auth_del_ent_mem ON "constructive_store_private".org_secrets
FOR DELETE
TO authenticated
USING (
