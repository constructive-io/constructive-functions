-- Deploy: schemas/constructive_store_private/trigger_fns/platform_secrets_hash
-- made with <3 @ constructive.io

-- requires: schemas/constructive_store_private/schema


CREATE FUNCTION "constructive_store_private".platform_secrets_hash() RETURNS TRIGGER AS $_PGFN_$
BEGIN
