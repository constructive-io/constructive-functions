-- Deploy: schemas/constructive_store_public/tables/platform_config/policies/auth_ins_app_mem/policy
...
CREATE POLICY auth_ins_app_mem ON "constructive_store_public".platform_config
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
