-- Deploy: schemas/constructive_store_public/tables/platform_config_definitions/policies/auth_upd_app_mem/policy
...
CREATE POLICY auth_upd_app_mem ON "constructive_store_public".platform_config_definitions
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
