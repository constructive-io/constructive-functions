-- Deploy: schemas/constructive_memberships_private/tables/org_memberships_sprt/indexes/org_memberships_sprts_entity_id_idx
...
CREATE INDEX org_memberships_sprts_entity_id_idx ON "constructive_memberships_private".org_memberships_sprt USING BTREE ( entity_id ) INCLUDE ( permissions, is_owner, is_admin, is_read_only );
